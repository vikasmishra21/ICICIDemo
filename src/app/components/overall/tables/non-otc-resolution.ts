...
export class NonOtcResolution {
  ...
  constructor() {
    ...
    this.chart.combineSideBreakOptions('v35', [1], 'No');
    this.chart.combineSideBreakOptions('v35', [2], 'Yes');
      ...
      config.series[0].itemStyle.normal = {
        color: function (a) {
         switch(a.dataIndex){        
          ...
          case 1: return 'rgba(0,149,217,1)';
          case 2: return 'rgba(0,119,174,1)';
