...
export type AfterConfigReady = (output: TableOutput[], config: ChartProviderConfiguration) => ChartProviderConfiguration;

export type AfterTableDataReady = (output: TableOutput[], dataTable: DataTable) => void;
